...
import com.hyphenate.easemob.im.officeautomation.widget.ParamsCreator;
...
public class MonIndicator extends View {
    ...
    private int[] colors = new int[]{0xFF505050, 0xFF505050, 0xFF505050, 0xFF505050, 0xFFFFFFFF};
    ...
    public MonIndicator(Context context, AttributeSet attrs) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.monindicator_circle_Radius, paramsCreator.getDefaultCircleRadius());
        circleSpacing = (int) a.getDimension(R.styleable.monindicator_circleSpacing, paramsCreator.getDefaultCircleSpacing());
        int cycle = a.getInt(R.styleable.monindicator_cycle, 1000);
        cycle = cycle / 2;
