...
/**
 * Created by qby on 2017/9/30.
 * 自定义ViewPagerIndicator,仿新浪微博效果
 */
...
public class CaterpillarIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public CaterpillarIndicator(Context context, AttributeSet attrs) {
        ...
        mPaddingBottom = a.getDimensionPixelOffset(R.styleable.CaterpillarIndicator_slide_padding_bottom, dip2px(0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawLineRect.bottom = bottomY - mPaddingBottom;
        drawLineRect.top = topY - mPaddingBottom;

        int roundXY = isRoundRectangleLine ? (mFooterLineHeight * 2 / 3) : 0;
