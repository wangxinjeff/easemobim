...
public class CustomTimePickerView extends View {
    public static final String TAG = "CustomTimePickerView";
    /**
    ...
    private int mColorText = 0x3BAFF0;
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        ...
        canvas.drawText(text, (float) (mViewWidth / 2.0), baseline, mPaint);
    }
