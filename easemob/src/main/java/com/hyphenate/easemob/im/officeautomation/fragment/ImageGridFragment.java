...
import com.hyphenate.easemob.BuildConfig;
import com.hyphenate.easemob.R;
import com.hyphenate.easemob.im.officeautomation.domain.VideoEntity;
import com.hyphenate.easemob.im.officeautomation.ui.RecorderVideoActivity;
import com.hyphenate.easemob.im.officeautomation.util.ImageCache;
import com.hyphenate.easemob.im.officeautomation.util.ImageResizer;
import com.hyphenate.easemob.im.officeautomation.util.Utils;
import com.hyphenate.easemob.im.officeautomation.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			Intent intent=getActivity().getIntent().putExtra("path", vEntty.getFilePath()).putExtra("dur", vEntty.getDuration());
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.tvDur.setText(DateUtils.toTime(entty.getDuration()));
				holder.tvSize.setText(TextFormater.getDataSize(entty.getSize()));
				holder.imageView.setImageResource(R.drawable.em_empty_photo);
				mImageResizer.loadImage(entty.getFilePath(), holder.imageView);
			}
			return convertView;
