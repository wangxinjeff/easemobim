...
public class EaseEmojiconScrollTabBar extends RelativeLayout{
    ...
    public void addTab(int icon){
        ...
        int tabWidth = getResources().getDimensionPixelSize(R.dimen.dp_60);
        LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(tabWidth, LayoutParams.MATCH_PARENT);
