...
import com.hyphenate.easemob.easeui.widget.emojicon.EaseEmojiconPagerView.EaseEmojiconPagerViewListener;
import com.hyphenate.easemob.easeui.widget.emojicon.EaseEmojiconScrollTabBar.EaseScrollTabBarItemClickListener;
...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase{
	...
	public void selectedTo(final int position){
		tabBar.selectedTo(position);
		pagerView.setGroupPostion(position);
	}
    ...
    public void replaceEmojiconGroup(int position, EaseEmojiconGroupEntity groupEntity){
    	emojiconGroupList.set(position, groupEntity);
    	pagerView.replaceEmojiconGroup(position, groupEntity);
    }
