...
public class EaseSmileUtils {
    ...
    public static final String ee_36 = "[石化]";
    public static final String ee_37 = "[炸弹]";
    public static final String ee_38 = "[捂脸]";
    public static final String ee_39 = "[奋斗]";
    public static final String ee_40 = "[抱抱]";
    public static final String ee_41 = "[西瓜]";
    public static final String ee_42 = "[握手]";
    public static final String ee_43 = "[ok]";
    public static final String ee_44 = "[拳头]";
    public static final String ee_45 = "[举手]";
    public static final String ee_46 = "[胜利]";
    public static final String ee_47 = "[啤酒]";
    public static final String ee_48 = "[咖啡]";
    public static final String ee_49 = "[睡觉]";
    public static final String ee_50 = "[口罩]";
