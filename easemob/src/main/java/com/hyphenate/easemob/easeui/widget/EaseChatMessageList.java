...
public class EaseChatMessageList extends RelativeLayout{
     ...
     */
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider, HashMap<String, EMMessage> checkMap) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, chatType, listView, checkMap);
    ...
    public void showCheckbox() {
        messageAdapter.showCheckbox();
    }
    public void hideCheckbox() {
        messageAdapter.hideCheckbox();
    }
    ...
    public interface MessageListItemClickListener{
	    ...
	    void onBubbleLongClick(ImageView imageView, View v, EMMessage message, int position);
