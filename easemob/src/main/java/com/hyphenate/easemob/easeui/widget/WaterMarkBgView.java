...
public class WaterMarkBgView {
    ...
    private static WaterMarkBgView sInstance;

    private WaterMarkBgView() {
        mText = "";
        mTextColor = 0x33AEAEAE;
        mTextSize = 12;
        mRotation = -30;
    }

    public static WaterMarkBgView getInstance() {
        if (sInstance == null) {
            synchronized (WaterMarkBgView.class) {
                sInstance = new WaterMarkBgView();
            }
        }
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public WaterMarkBgView setText(String text) {
        mText = text;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public WaterMarkBgView setTextColor(int color) {
        mTextColor = color;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public WaterMarkBgView setTextSize(float size) {
        mTextSize = size;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public WaterMarkBgView setRotation(float degrees) {
        mRotation = degrees;
        return sInstance;
    }
    ...
    private class WatermarkDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            mPaint.setTextSize(ConvertUtils.sp2px(mTextSize));
