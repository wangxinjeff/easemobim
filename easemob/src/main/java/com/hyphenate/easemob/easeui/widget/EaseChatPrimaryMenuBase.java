...
public abstract class EaseChatPrimaryMenuBase extends RelativeLayout{
     ...
     * @param message
     */
    public abstract void showReference(EMMessage message);

    /**
     * 输入栏隐藏引用消息
     */
    public abstract void hideReference();
    ...
    public void showKeyboard() {
        ...
        imm.showSoftInput(getEditText(), InputMethodManager.RESULT_UNCHANGED_SHOWN);
    }
    ...
    public interface EaseChatPrimaryMenuListener{
         ...
         * @param content
         */
        boolean onSendBtnClicked(String content);
