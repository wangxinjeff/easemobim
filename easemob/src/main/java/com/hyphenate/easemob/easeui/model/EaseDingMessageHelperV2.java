...
public class EaseDingMessageHelperV2 {
    /**
    ...
    private static EaseDingMessageHelperV2 instance;
    ...
    public static EaseDingMessageHelperV2 get() {
        if (instance == null) {
            synchronized (EaseDingMessageHelperV2.class) {
                if (instance == null) {
                    instance = new EaseDingMessageHelperV2(EMClient.getInstance().getContext());
                }
            }
        }
        return instance;
    ...
    EaseDingMessageHelperV2(Context context) {
