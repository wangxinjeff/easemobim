package com.hyphenate.easemob.imlibs.badge;
...
public class QBadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = getResources().getDimensionPixelSize(R.dimen.dp_11);
        mBadgePadding = getResources().getDimensionPixelSize(R.dimen.dp_5);
        mBadgeNumber = 0;
        ...
        mFinalDragDistance =getResources().getDimensionPixelSize(R.dimen.dp_90);
        mShowShadow = true;
